...
seoTitle: WorkspaceMember | kenh-ai Python SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/python/api-reference/components/workspacemember
'og:site_name': kenh-ai Documentation
'og:title': WorkspaceMember | kenh-ai Python SDK
'og:description': >-
  WorkspaceMember method documentation for the kenh-ai Python SDK. Learn how
  to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=WorkspaceMember%20-%20Python%20SDK&description=WorkspaceMember%20method%20reference
'og:image:width': 1200
'og:image:height': 630
