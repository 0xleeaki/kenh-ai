...
canonicalUrl: https://openrouter.ai/docs/guides/features/tool-calling
...
For more details on OpenRouter's message format and tool parameters, see the [API Reference](/api/reference/overview).
