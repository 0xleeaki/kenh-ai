...
seoTitle: ApplyPatchCallOperation Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/applypatchcalloperation
'og:site_name': kenh-ai Documentation
'og:title': ApplyPatchCallOperation Type | kenh-ai Go SDK
'og:description': >-
  ApplyPatchCallOperation type reference for the kenh-ai Go SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ApplyPatchCallOperation%20-%20Go%20SDK&description=ApplyPatchCallOperation%20type%20definition
'og:image:width': 1200
'og:image:height': 630
