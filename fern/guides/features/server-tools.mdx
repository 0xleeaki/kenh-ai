...
canonicalUrl: https://openrouter.ai/docs/guides/features/server-tools
og:site_name: OpenRouter Documentation
og:title: 'Server Tools - Model-Callable Tools by OpenRouter'
og:description: 'Add powerful server-side tools like web search, web fetch, datetime, and image generation to any model on OpenRouter. Models decide when to call them — OpenRouter executes them automatically.'
