...
seoTitle: 'Text Generation | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/text-generation'
og:site_name: kenh-ai Documentation
og:title: 'Text Generation - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Text%20Generation&description=Generate%20Text%20with%20callModel
og:image:width: 1200
og:image:height: 630
...
Specify a model by its kenh-ai ID:
