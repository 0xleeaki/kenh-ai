---
title: Plugins
description: Extend model capabilities with kenh-ai plugins
seoTitle: 'Plugins | Extend AI Model Capabilities'
canonicalUrl: https://kenh-ai.com/docs/guides/features/plugins
og:site_name: kenh-ai Documentation
og:title: 'Plugins - Extend AI Model Capabilities'
og:description: "Enable powerful plugins like web search, PDF processing, and response healing to extend any model's capabilities on kenh-ai."
og:image: https://kenh-ai.com/dynamic-og?title=Plugins&description=Extend%20AI%20Model%20Capabilities
og:image:width: 1200
og:image:height: 630
