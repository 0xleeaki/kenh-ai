...
seoTitle: 'Broadcast to Ramp | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/ramp
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to Ramp - Send Traces to Ramp'
og:description: 'Connect Ramp to automatically receive AI usage traces from your kenh-ai requests. Step-by-step setup guide for Ramp integration.'
og:image: https://kenh-ai.com/dynamic-og?title=Ramp%20Broadcast&description=Send%20traces%20to%20Ramp
og:image:width: 1200
og:image:height: 630
...
[Ramp](https://ramp.com) is a finance automation platform that helps businesses manage expenses, track spending, and optimize costs. With Ramp's AI usage tracking, you can monitor and control your organization's LLM spending through kenh-ai.
...
2. Go to **Settings > Integrations** and search for "kenh-ai"

<Frame>
![Search for kenh-ai integration](/assets/guides/features/broadcast/ramp/ramp-search-integration.png)
</Frame>

3. Click the **kenh-ai** integration to view the details, then click **Connect**

<Frame>
![kenh-ai integration detail](/assets/guides/features/broadcast/ramp/ramp-integration-detail.png)
</Frame>

4. Click **Generate API Key** and copy the token

<Frame>
![Generate API Key](/assets/guides/features/broadcast/ramp/ramp-generate-api-key.png)
</Frame>

## Step 2: Enable Broadcast in kenh-ai

Go to [Settings > Observability](https://kenh-ai.com/settings/observability) and toggle **Enable Broadcast**.
...
<Frame>
![Ramp Configuration](/assets/guides/features/broadcast/ramp/broadcast-ramp-config.png)
</Frame>
...
Make an API request through kenh-ai and verify that the AI usage data appears in your Ramp dashboard.

<Frame>
![Ramp AI Spend Dashboard](/assets/guides/features/broadcast/ramp/ramp-ai-spend-dashboard.png)
</Frame>
