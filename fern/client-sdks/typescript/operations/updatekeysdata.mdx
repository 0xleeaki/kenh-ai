---
title: UpdateKeysData - TypeScript SDK
description: UpdateKeysData method reference
seoTitle: UpdateKeysData | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/operations/updatekeysdata'
'og:site_name': kenh-ai Documentation
'og:title': UpdateKeysData | kenh-ai TypeScript SDK
'og:description': >-
  UpdateKeysData method documentation for the kenh-ai TypeScript SDK. Learn
  how to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=UpdateKeysData%20-%20TypeScript%20SDK&description=UpdateKeysData%20method%20reference
'og:image:width': 1200
'og:image:height': 630
...
import { UpdateKeysData } from "@kenh-ai/sdk/models/operations";
...
| `usage`                                                                                       | *number*                                                                                      | :heavy_check_mark:                                                                            | Total kenh-ai credit usage (in USD) for the API key                                        | 25.5                                                                                          |
| `usageDaily`                                                                                  | *number*                                                                                      | :heavy_check_mark:                                                                            | kenh-ai credit usage (in USD) for the current UTC day                                      | 25.5                                                                                          |
| `usageWeekly`                                                                                 | *number*                                                                                      | :heavy_check_mark:                                                                            | kenh-ai credit usage (in USD) for the current UTC week (Monday-Sunday)                     | 25.5                                                                                          |
| `usageMonthly`                                                                                | *number*                                                                                      | :heavy_check_mark:                                                                            | kenh-ai credit usage (in USD) for the current UTC month                                    | 25.5                                                                                          |
