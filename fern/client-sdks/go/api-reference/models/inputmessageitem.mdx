...
seoTitle: InputMessageItem Type | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/models/inputmessageitem'
'og:site_name': kenh-ai Documentation
'og:title': InputMessageItem Type | kenh-ai Go SDK
'og:description': >-
  InputMessageItem type reference for the kenh-ai Go SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=InputMessageItem%20-%20Go%20SDK&description=InputMessageItem%20type%20definition
'og:image:width': 1200
'og:image:height': 630
