...
seoTitle: Options Type | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/operations/option'
'og:site_name': kenh-ai Documentation
'og:title': Options Type | kenh-ai Go SDK
'og:description': >-
  Options type reference for the kenh-ai Go SDK. Complete type definition and
  usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Options%20-%20Go%20SDK&description=Options%20type%20definition
'og:image:width': 1200
'og:image:height': 630
