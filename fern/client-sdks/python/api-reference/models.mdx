...
seoTitle: Models | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/api-reference/models'
'og:site_name': kenh-ai Documentation
'og:title': Models | kenh-ai Python SDK
'og:description': >-
  Models method documentation for the kenh-ai Python SDK. Learn how to use
  this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Models%20-%20Python%20SDK&description=Models%20method%20reference
'og:image:width': 1200
'og:image:height': 630
...
```python lines
from kenh_ai import kenh-ai, operations
import os
...
with KenhAI(
    ...
    res = open_router.models.list_for_user(security=operations.ListModelsUserSecurity(
        bearer=os.getenv("KENH_AI_BEARER", ""),
    ))
