...
seoTitle: OpenAIResponseCustomToolCallOutputOutput1 Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/openairesponsecustomtoolcalloutputoutput1
'og:site_name': kenh-ai Documentation
'og:title': OpenAIResponseCustomToolCallOutputOutput1 Type | kenh-ai Go SDK
'og:description': >-
  OpenAIResponseCustomToolCallOutputOutput1 type reference for the kenh-ai Go
  SDK. Complete type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=OpenAIResponseCustomToolCallOutputOutput1%20-%20Go%20SDK&description=OpenAIResponseCustomToolCallOutputOutput1%20type%20definition
'og:image:width': 1200
'og:image:height': 630
