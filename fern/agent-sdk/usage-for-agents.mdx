...
description: Add kenh-ai Agent SDK skills to your AI coding assistant
seoTitle: 'Usage for Agents | kenh-ai Agent SDK'
canonicalUrl: https://kenh-ai.com/docs/agent-sdk/usage-for-agents
og:site_name: kenh-ai Documentation
og:title: 'Usage for Agents | kenh-ai Agent SDK'
og:description: >-
  Add kenh-ai Agent SDK skills to AI coding assistants like Claude Code, Cursor,
  GitHub Copilot, and more. Enable your AI to code with the kenh-ai Agent SDK.
og:image: >-
  https://kenh-ai.com/dynamic-og?title=Usage%20for%20Agents&description=Add%20kenh-ai%20Agent%20SDK%20skills%20to%20your%20AI%20coding%20assistant
og:image:width: 1200
og:image:height: 630
...
Give your AI coding assistant the knowledge to work with the kenh-ai Agent SDK
...
The skill covers both the Agent SDK (`@kenh-ai/agent`) and the Client SDKs (`@kenh-ai/sdk`).
...
**"Help me set up an kenh-ai agent"**

The assistant will know to use:

```typescript lines
import { callModel } from '@kenh-ai/agent';
