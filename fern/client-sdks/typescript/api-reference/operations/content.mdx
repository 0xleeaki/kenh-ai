...
seoTitle: Content Type | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/api-reference/operations/content'
'og:site_name': kenh-ai Documentation
'og:title': Content Type | kenh-ai TypeScript SDK
'og:description': >-
  Content type reference for the kenh-ai TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Content%20-%20TypeScript%20SDK&description=Content%20type%20definition
'og:image:width': 1200
'og:image:height': 630
