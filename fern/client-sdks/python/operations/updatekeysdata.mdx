...
seoTitle: UpdateKeysData | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/operations/updatekeysdata'
'og:site_name': kenh-ai Documentation
'og:title': UpdateKeysData | kenh-ai Python SDK
'og:description': >-
  UpdateKeysData method documentation for the kenh-ai Python SDK. Learn how
  to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=UpdateKeysData%20-%20Python%20SDK&description=UpdateKeysData%20method%20reference
'og:image:width': 1200
'og:image:height': 630
...
| `usage`                                                                   | *float*                                                                   | :heavy_check_mark:                                                        | Total kenh-ai credit usage (in USD) for the API key                    | 25.5                                                                      |
| `usage_daily`                                                             | *float*                                                                   | :heavy_check_mark:                                                        | kenh-ai credit usage (in USD) for the current UTC day                  | 25.5                                                                      |
| `usage_weekly`                                                            | *float*                                                                   | :heavy_check_mark:                                                        | kenh-ai credit usage (in USD) for the current UTC week (Monday-Sunday) | 25.5                                                                      |
| `usage_monthly`                                                           | *float*                                                                   | :heavy_check_mark:                                                        | kenh-ai credit usage (in USD) for the current UTC month                | 25.5                                                                      |
