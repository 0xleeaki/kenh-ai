---
title: Options - TypeScript SDK
sidebarTitle: Options
description: Options type definition
seoTitle: Options Type | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/api-reference/models/options'
'og:site_name': kenh-ai Documentation
'og:title': Options Type | kenh-ai TypeScript SDK
'og:description': >-
  Options type reference for the kenh-ai TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Options%20-%20TypeScript%20SDK&description=Options%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { Options } from "@kenh-ai/sdk/models";
