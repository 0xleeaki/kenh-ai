...
seoTitle: 'Broadcast to LangSmith | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/langsmith
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to LangSmith - Send Traces to LangSmith'
og:description: 'Connect LangSmith to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for LangSmith integration.'
og:image: https://kenh-ai.com/dynamic-og?title=LangSmith%20Broadcast&description=Send%20traces%20to%20LangSmith
og:image:width: 1200
og:image:height: 630
...
Make an API request through kenh-ai and view the trace in LangSmith. Your traces will appear in the specified project with full details including:
...
kenh-ai sends traces to LangSmith using the OpenTelemetry (OTEL) protocol with the following attributes:
...
kenh-ai maps observation types to LangSmith run types:
