...
seoTitle: ChatStreamToolCall Type | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/models/chatstreamtoolcall'
'og:site_name': kenh-ai Documentation
'og:title': ChatStreamToolCall Type | kenh-ai Go SDK
'og:description': >-
  ChatStreamToolCall type reference for the kenh-ai Go SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ChatStreamToolCall%20-%20Go%20SDK&description=ChatStreamToolCall%20type%20definition
'og:image:width': 1200
'og:image:height': 630
