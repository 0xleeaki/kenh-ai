...
seoTitle: InputMessageItemContentUnion Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/inputmessageitemcontentunion
'og:site_name': kenh-ai Documentation
'og:title': InputMessageItemContentUnion Type | kenh-ai Go SDK
'og:description': >-
  InputMessageItemContentUnion type reference for the kenh-ai Go SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=InputMessageItemContentUnion%20-%20Go%20SDK&description=InputMessageItemContentUnion%20type%20definition
'og:image:width': 1200
'og:image:height': 630
