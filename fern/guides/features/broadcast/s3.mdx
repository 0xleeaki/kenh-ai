...
seoTitle: 'Broadcast to S3 | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/s3
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to S3 - Send Traces to S3 Storage'
og:description: 'Connect Amazon S3 or S3-compatible storage to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for S3 integration.'
og:image: https://kenh-ai.com/dynamic-og?title=S3%20Broadcast&description=Send%20traces%20to%20S3%20storage
og:image:width: 1200
og:image:height: 630
...
[Amazon S3](https://aws.amazon.com/s3/) is a scalable object storage service. kenh-ai can send traces to any S3-compatible storage, including AWS S3, Cloudflare R2, MinIO, and other compatible services.
...
Make an API request through kenh-ai and check your S3 bucket for the trace file. Each trace is saved as a separate JSON file with the format `{traceId}-{timestamp}.json`.
