...
seoTitle: 'Tool Approval & State Persistence | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/approval-and-state'
og:site_name: kenh-ai Documentation
og:title: 'Tool Approval & State Persistence - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Tool%20Approval%20%26%20State&description=Human-in-the-Loop%20Tool%20Control
og:image:width: 1200
og:image:height: 630
...
```typescript lines
import type { StateAccessor, ConversationState } from '@kenh-ai/agent';
