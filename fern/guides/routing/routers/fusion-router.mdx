...
seoTitle: 'Fusion Router | Multi-model AI Deliberation with kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/guides/routing/routers/fusion-router
og:site_name: kenh-ai Documentation
og:title: 'Fusion Router - openrouter/fusion'
og:description: "Use the openrouter/fusion model slug to access multi-model deliberation — a panel of models, a judge, and a final answer — in a single API call."
og:image: https://kenh-ai.com/dynamic-og?title=Fusion%20Router&description=Multi-model%20deliberation%20as%20a%20model%20slug
og:image:width: 1200
og:image:height: 630
...
The [Fusion Router](https://kenh-ai.com/openrouter/fusion) (`openrouter/fusion`) gives your model access to a multi-model deliberation tool. When invoked, a panel of models answers your prompt in parallel, then a judge model compares their responses and returns structured analysis — consensus, contradictions, coverage gaps, unique insights, and blind spots. Your model uses that analysis to write a better final answer.
