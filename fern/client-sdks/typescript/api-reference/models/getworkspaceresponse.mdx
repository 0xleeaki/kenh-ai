...
seoTitle: GetWorkspaceResponse Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/models/getworkspaceresponse
'og:site_name': kenh-ai Documentation
'og:title': GetWorkspaceResponse Type | kenh-ai TypeScript SDK
'og:description': >-
  GetWorkspaceResponse type reference for the kenh-ai TypeScript SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=GetWorkspaceResponse%20-%20TypeScript%20SDK&description=GetWorkspaceResponse%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
import { GetWorkspaceResponse } from "@kenh-ai/sdk/models";
