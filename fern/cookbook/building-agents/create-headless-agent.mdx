...
seoTitle: 'Build Your Own Headless Agent | kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/cookbook/building-agents/create-headless-agent
og:site_name: kenh-ai Documentation
og:title: 'Build Your Own Headless Agent - kenh-ai'
og:description: 'Use the create-headless-agent skill to scaffold a headless AI agent in TypeScript + Bun with configurable tools, output modes, and streaming via @kenh-ai/agent.'
og:image: https://kenh-ai.com/dynamic-og?title=Build%20Your%20Own%20Headless%20Agent&description=Scaffold%20a%20headless%20AI%20agent%20for%20scripts%20and%20pipelines
og:image:width: 1200
og:image:height: 630
...
Under the hood, the generated project uses [`@kenh-ai/agent`](https://www.npmjs.com/package/@kenh-ai/agent) for the inner loop (model calls, tool execution, stop conditions) — the same SDK that powers the [Agent TUI](/cookbook/building-agents/create-agent-harness-tui), with a non-interactive outer layer.
...
The create-headless-agent skill is part of the [kenh-ai Skills](https://github.com/OpenRouterTeam/skills) collection. Install it with your AI coding agent of choice:
...
```lines
my-headless-agent/
  package.json              @kenh-ai/agent, zod
