...
description: Manage teams and shared resources with kenh-ai organizations
seoTitle: 'kenh-ai Organization Management | Developer Documentation'
canonicalUrl: https://kenh-ai.com/docs/cookbook/administration/organization-management
og:site_name: kenh-ai Documentation
og:title: 'kenh-ai Organization Management'
og:description: "Learn how to create and manage organizations on kenh-ai for team collaboration, shared credits, and centralized API management."
og:image: https://kenh-ai.com/dynamic-og?pathname=use-cases/organization-management&title=Organization%20Management&description=Team%20collaboration%20and%20shared%20resources
og:image:width: 1200
og:image:height: 630
...
1. Navigate to [Settings > Preferences](https://kenh-ai.com/settings/preferences)
...
1. Email [support@kenh-ai.com](mailto:support@kenh-ai.com) with your request
...
<AccordionGroup>
  <Accordion title="Can I convert my personal account to an organization?">
    No, organizations are separate entities. You'll need to create a new organization and transfer resources as needed. Contact support@kenh-ai.com for assistance with credit transfers.
  </Accordion>
  ...
  <Accordion title="Can organization members see each other's usage data?">
    Organization members can see usage metadata (model used, cost, timing) for all organization activity in the activity feed. kenh-ai does not store prompts or responses.
  </Accordion>
...
- **Technical Support**: Email [support@kenh-ai.com](mailto:support@kenh-ai.com)
- **Credit Transfers**: Email [support@kenh-ai.com](mailto:support@kenh-ai.com) with transfer requests
