...
canonicalUrl: https://kenh-ai.com/docs/guides/routing/routers/free-router
og:site_name: kenh-ai Documentation
og:title: 'Free Models Router - Zero-Cost AI Inference'
og:description: "Route requests to free AI models automatically using kenh-ai's Free Models Router."
og:image: https://kenh-ai.com/dynamic-og?title=Free%20Models%20Router&description=Zero-cost%20AI%20inference
og:image:width: 1200
og:image:height: 630
...
The Free Models Router selects from all currently available free models on kenh-ai. Some popular options include:

<Warning>
Free model availability changes frequently. Check the [models page](https://kenh-ai.com/models?pricing=free) for the current list of free models.
</Warning>
...
2. **Browse free models**: Visit the [models page](https://kenh-ai.com/models?pricing=free) to see all available free models and select one directly.
