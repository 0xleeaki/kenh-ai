...
seoTitle: ChatContentItems Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/models/chatcontentitems
'og:site_name': kenh-ai Documentation
'og:title': ChatContentItems Type | kenh-ai TypeScript SDK
'og:description': >-
  ChatContentItems type reference for the kenh-ai TypeScript SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ChatContentItems%20-%20TypeScript%20SDK&description=ChatContentItems%20type%20definition
'og:image:width': 1200
'og:image:height': 630
