...
seoTitle: 'Streaming | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/streaming'
og:site_name: kenh-ai Documentation
og:title: 'Streaming - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Streaming&description=Real-time%20Response%20Streaming
og:image:width: 1200
og:image:height: 630
...
function ChatResponse({ prompt }: { prompt: string }) {
  ...
  useEffect(() => {
    const openrouter = new KenhAI({ apiKey: API_KEY });
