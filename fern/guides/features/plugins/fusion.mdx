...
seoTitle: 'Fusion | Multi-model AI Analysis with OpenRouter'
canonicalUrl: https://openrouter.ai/docs/guides/features/plugins/fusion
og:site_name: OpenRouter Documentation
og:title: 'Fusion - Multi-model Analysis on OpenRouter'
og:description: "Get richer answers by running a panel of models in parallel and comparing their responses through a judge. Fusion makes this a one-line addition to any OpenRouter request."
og:image: https://openrouter.ai/dynamic-og?title=Fusion&description=Multi-model%20Analysis%20with%20a%20Judge%20Model
og:image:width: 1200
og:image:height: 630
