---
title: Fusion
description: Multi-model analysis with a judge model
seoTitle: 'Fusion | Multi-model AI Analysis with kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/guides/features/plugins/fusion
og:site_name: kenh-ai Documentation
og:title: 'Fusion - Multi-model Analysis on kenh-ai'
og:description: "Get richer answers by running a panel of models in parallel and comparing their responses through a judge. Fusion makes this a one-line addition to any kenh-ai request."
og:image: https://kenh-ai.com/dynamic-og?title=Fusion&description=Multi-model%20Analysis%20with%20a%20Judge%20Model
og:image:width: 1200
og:image:height: 630
...
When you send `model: "openrouter/fusion"` without a plugin config, the defaults match the **Quality** preset on the [Fusion lab](https://kenh-ai.com/fusion/).
...
- [`/labs/fusion`](https://kenh-ai.com/fusion/) — interactive playground
