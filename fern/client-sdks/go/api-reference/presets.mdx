...
seoTitle: Presets | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/presets'
'og:site_name': kenh-ai Documentation
'og:title': Presets | kenh-ai Go SDK
'og:description': >-
  Presets method documentation for the kenh-ai Go SDK. Learn how to use this
  API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Presets%20-%20Go%20SDK&description=Presets%20method%20reference
'og:image:width': 1200
'og:image:height': 630
