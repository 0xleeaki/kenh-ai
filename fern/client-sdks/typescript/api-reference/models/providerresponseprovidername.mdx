...
seoTitle: ProviderResponseProviderName Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/models/providerresponseprovidername
'og:site_name': kenh-ai Documentation
'og:title': ProviderResponseProviderName Type | kenh-ai TypeScript SDK
'og:description': >-
  ProviderResponseProviderName type reference for the kenh-ai TypeScript SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ProviderResponseProviderName%20-%20TypeScript%20SDK&description=ProviderResponseProviderName%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { ProviderResponseProviderName } from "@kenh-ai/sdk/models";
