...
canonicalUrl: https://kenh-ai.com/docs/guides/routing/model-variants/free
...
og:image: https://kenh-ai.com/dynamic-og?title=Free%20Variant&description=Free%20model%20access
og:image:width: 1200
og:image:height: 630
...
The `:free` variant allows you to access free versions of models on kenh-ai.
