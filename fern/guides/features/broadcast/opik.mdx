...
seoTitle: 'Broadcast to Comet Opik | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/opik
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to Comet Opik - Send Traces to Opik'
og:description: 'Connect Comet Opik to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for Opik integration.'
og:image: https://kenh-ai.com/dynamic-og?title=Comet%20Opik%20Broadcast&description=Send%20traces%20to%20Comet%20Opik
og:image:width: 1200
og:image:height: 630
...
Make an API request through kenh-ai and view the trace in your Opik
project dashboard.

<Frame>
![Opik Trace View](/assets/guides/features/broadcast/opik/broadcast-opik-trace.png)
</Frame>
...
- Opik uses UUIDv7 format for trace and span IDs internally; original kenh-ai IDs are stored in metadata as `openrouter_trace_id` and `openrouter_observation_id`
