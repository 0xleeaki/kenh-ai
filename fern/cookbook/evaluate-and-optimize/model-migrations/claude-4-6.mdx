...
seoTitle: 'Claude 4.6 Migration Guide | kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/cookbook/evaluate-and-optimize/model-migrations/claude-4-6
...
og:image: https://kenh-ai.com/dynamic-og?title=Claude%204.6%20Migration%20Guide&description=Adaptive%20thinking%20and%20max%20effort%20level
og:image:width: 1200
og:image:height: 630
...
For Claude 4.6 Opus and 4.6 Sonnet, kenh-ai now uses adaptive thinking (`thinking.type: 'adaptive'`) by default instead of budget-based thinking (`thinking.type: 'enabled'` with `budget_tokens`).
