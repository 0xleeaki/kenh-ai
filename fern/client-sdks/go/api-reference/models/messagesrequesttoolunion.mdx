...
seoTitle: MessagesRequestToolUnion Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/messagesrequesttoolunion
'og:site_name': kenh-ai Documentation
'og:title': MessagesRequestToolUnion Type | kenh-ai Go SDK
'og:description': >-
  MessagesRequestToolUnion type reference for the kenh-ai Go SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=MessagesRequestToolUnion%20-%20Go%20SDK&description=MessagesRequestToolUnion%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```go lines
messagesRequestToolUnion := components.CreateMessagesRequestToolUnionImageGenerationServerToolKenhAI(components.ImageGenerationServerToolkenh-ai{/* values here */})
```
...
switch messagesRequestToolUnion.Type {
	...
	case components.MessagesRequestToolUnionTypeImageGenerationServerToolkenh-ai:
		// messagesRequestToolUnion.ImageGenerationServerToolkenh-ai is populated
