...
og:description: 'Build powerful AI automations by connecting OpenRouter with 8000+ apps through Zapier. Access 300+ AI models in your workflows.'
...
import { ZapierIframe } from '../../snippets/exports/ZapierIframe.jsx';

With OpenRouter you have access to over 300+ AI models through one API, and with Zapier you can connect to 8000+ apps to automate workflows, no coding required!
