...
seoTitle: FrameImage | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/api-reference/components/frameimage'
'og:site_name': kenh-ai Documentation
'og:title': FrameImage | kenh-ai Python SDK
'og:description': >-
  FrameImage method documentation for the kenh-ai Python SDK. Learn how to
  use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=FrameImage%20-%20Python%20SDK&description=FrameImage%20method%20reference
'og:image:width': 1200
'og:image:height': 630
