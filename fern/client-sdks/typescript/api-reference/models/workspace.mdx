---
title: Workspace - TypeScript SDK
sidebarTitle: Workspace
description: Workspace type definition
seoTitle: Workspace Type | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/api-reference/models/workspace'
'og:site_name': kenh-ai Documentation
'og:title': Workspace Type | kenh-ai TypeScript SDK
'og:description': >-
  Workspace type reference for the kenh-ai TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Workspace%20-%20TypeScript%20SDK&description=Workspace%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { Workspace } from "@kenh-ai/sdk/models";
