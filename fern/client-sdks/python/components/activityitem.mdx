...
seoTitle: ActivityItem | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/components/activityitem'
'og:site_name': kenh-ai Documentation
'og:title': ActivityItem | kenh-ai Python SDK
'og:description': >-
  ActivityItem method documentation for the kenh-ai Python SDK. Learn how to
  use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ActivityItem%20-%20Python%20SDK&description=ActivityItem%20method%20reference
'og:image:width': 1200
'og:image:height': 630
...
| `usage`                                             | *float*                                             | :heavy_check_mark:                                  | Total cost in USD (kenh-ai credits spent)        | 0.015                                               |
