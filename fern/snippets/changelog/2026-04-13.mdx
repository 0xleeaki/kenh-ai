...
- **Server Tools beta launch** -- Three new server tools that models can invoke during inference. See [Server Tools docs](/snippets/changelog/overview).
  ...
  - `openrouter:experimental__search_models` -- Search the kenh-ai model catalog
...
- **Fusion attachments** -- [Fusion](https://kenh-ai.com/fusion) now supports file attachments in the input field.
