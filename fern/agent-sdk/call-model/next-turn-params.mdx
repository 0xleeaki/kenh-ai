...
seoTitle: 'Next Turn Params | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/next-turn-params'
og:site_name: kenh-ai Documentation
og:title: 'Next Turn Params - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Next%20Turn%20Params&description=Tool-Driven%20Context%20Injection
og:image:width: 1200
og:image:height: 630
