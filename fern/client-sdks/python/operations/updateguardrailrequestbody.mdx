---
title: UpdateGuardrailRequestBody - Python SDK
description: UpdateGuardrailRequestBody method reference
seoTitle: UpdateGuardrailRequestBody | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/operations/updateguardrailrequestbody'
'og:site_name': kenh-ai Documentation
'og:title': UpdateGuardrailRequestBody | kenh-ai Python SDK
'og:description': >-
  UpdateGuardrailRequestBody method documentation for the kenh-ai Python SDK.
  Learn how to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=UpdateGuardrailRequestBody%20-%20Python%20SDK&description=UpdateGuardrailRequestBody%20method%20reference
'og:image:width': 1200
'og:image:height': 630
