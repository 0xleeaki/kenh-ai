...
- **More SDK examples on model pages** -- Model page API tabs now include kenh-ai Python/Go and Anthropic TS/Go SDK examples, grouped by SDK category.
...
- **Stripe Projects integration guide** -- Published a guide for integrating kenh-ai via [Stripe Projects CLI](/guides/overview/stripe-projects).
...
- [**Anthropic: Claude Opus 4.7**](https://kenh-ai.com/anthropic/claude-opus-4.7)
