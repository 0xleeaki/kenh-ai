...
seoTitle: 'Skills Loader Example | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/tool-examples/skills-loader'

og:site_name: kenh-ai Documentation
og:title: 'Skills Loader Example - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Skills%20Loader&description=Context%20Injection%20Pattern
og:image:width: 1200
og:image:height: 630
...
```typescript expandable lines
import { kenh-ai, tool, stepCountIs } from '@kenh-ai/agent';
import { readFileSync, existsSync, readdirSync } from 'fs';
import path from 'path';
import { z } from 'zod';
