...
seoTitle: BadRequestResponseError Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/badrequestresponseerror
'og:site_name': kenh-ai Documentation
'og:title': BadRequestResponseError Type | kenh-ai Go SDK
'og:description': >-
  BadRequestResponseError type reference for the kenh-ai Go SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=BadRequestResponseError%20-%20Go%20SDK&description=BadRequestResponseError%20type%20definition
'og:image:width': 1200
'og:image:height': 630
