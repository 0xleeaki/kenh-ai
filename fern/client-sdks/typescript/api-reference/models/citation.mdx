...
seoTitle: Citation Type | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/api-reference/models/citation'
'og:site_name': kenh-ai Documentation
'og:title': Citation Type | kenh-ai TypeScript SDK
'og:description': >-
  Citation type reference for the kenh-ai TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Citation%20-%20TypeScript%20SDK&description=Citation%20type%20definition
'og:image:width': 1200
'og:image:height': 630
