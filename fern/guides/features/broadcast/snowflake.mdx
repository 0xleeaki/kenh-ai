...
seoTitle: 'Broadcast to Snowflake | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/snowflake
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to Snowflake - Send Traces to Your Data Warehouse'
og:description: 'Connect Snowflake to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for Snowflake integration.'
og:image: https://kenh-ai.com/dynamic-og?title=Snowflake%20Broadcast&description=Send%20traces%20to%20Snowflake
og:image:width: 1200
og:image:height: 630
...
[Snowflake](https://snowflake.com) is a cloud data warehouse platform. kenh-ai can stream traces directly to your Snowflake database for custom analytics, long-term storage, and business intelligence.

## Step 1: Create the traces table

Before connecting kenh-ai, create the `KENH_AI_TRACES` table in your Snowflake database. You can find the exact SQL in the kenh-ai dashboard when configuring the destination:

<Frame>
![Snowflake Table Setup](/assets/guides/features/broadcast/snowflake/snowflake-table-setup.png)
</Frame>
...
<Frame>
![Snowflake PAT](/assets/guides/features/broadcast/snowflake/snowflake-pat.png)
</Frame>

## Step 3: Enable Broadcast in kenh-ai
...
- **Table**: Table name (default: `KENH_AI_TRACES`).
...
Make an API request through kenh-ai and query your Snowflake table to verify the trace was received.

<Frame>
![Snowflake Test Trace](/assets/guides/features/broadcast/snowflake/snowflake-test-trace.png)
</Frame>
