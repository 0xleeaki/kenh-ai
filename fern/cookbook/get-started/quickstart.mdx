...
canonicalUrl: https://openrouter.ai/docs/cookbook/get-started/quickstart
...
from any model on OpenRouter. Install the SDK, send a message, and handle
...
import { CopyPromptButton } from '../../snippets/exports/CopyPromptButton.jsx';
