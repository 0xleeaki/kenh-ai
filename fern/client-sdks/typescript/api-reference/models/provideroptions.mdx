---
title: ProviderOptions - TypeScript SDK
sidebarTitle: ProviderOptions
description: ProviderOptions type definition
seoTitle: ProviderOptions Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/models/provideroptions
'og:site_name': kenh-ai Documentation
'og:title': ProviderOptions Type | kenh-ai TypeScript SDK
'og:description': >-
  ProviderOptions type reference for the kenh-ai TypeScript SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ProviderOptions%20-%20TypeScript%20SDK&description=ProviderOptions%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { ProviderOptions } from "@kenh-ai/sdk/models";
