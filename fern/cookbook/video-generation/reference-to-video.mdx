...
seoTitle: 'Guide a Video with Reference Images | kenh-ai Cookbook'
canonicalUrl: https://kenh-ai.com/docs/cookbook/video-generation/reference-to-video
og:site_name: kenh-ai Documentation
og:title: 'Guide a Video with Reference Images - kenh-ai Cookbook'
og:description: 'Submit an kenh-ai reference-to-video job with input_references when images should guide the generated result.'
og:image: https://kenh-ai.com/dynamic-og?title=Guide%20a%20Video%20with%20Reference%20Images&description=Use%20input%20references%20with%20kenh-ai%20video%20generation
og:image:width: 1200
og:image:height: 630
...
- A model that supports reference-to-video, confirmed from the current
  kenh-ai video docs or model description
