...
canonicalUrl: https://kenh-ai.com/docs/api/reference/responses/error-handling
og:site_name: kenh-ai Documentation
og:title: 'Responses API Beta Error Handling - Basic Error Guide'
og:description: "Learn how to handle errors in kenh-ai's Responses API Beta with the basic error response format."
og:image: https://kenh-ai.com/dynamic-og?title=Responses%20API%20Error%20Handling&description=Basic%20error%20handling%20guide
og:image:width: 1200
og:image:height: 630
