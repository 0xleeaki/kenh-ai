...
seoTitle: 'Call Model Overview (Typescript) | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/overview'
og:site_name: kenh-ai Documentation
og:title: 'Call Model Overview (Typescript) - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Call%20Model%20Overview%20(Typescript)&description=Unified%20LLM%20API%20with%20Tools
og:image:width: 1200
og:image:height: 630
...
- **Items-Based Model**: Built on kenh-ai's Responses API with structured
