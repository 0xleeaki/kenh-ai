...
canonicalUrl: https://kenh-ai.com/docs/cookbook/administration/crypto-api
...
og:image: https://kenh-ai.com/dynamic-og?title=Crypto%20API&description=Deprecated%20Coinbase%20Commerce%20Endpoint
og:image:width: 1200
og:image:height: 630
...
[credits page](https://kenh-ai.com/settings/credits). kenh-ai now uses Coinbase Business
