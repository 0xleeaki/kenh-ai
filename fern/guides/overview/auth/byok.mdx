...
canonicalUrl: https://openrouter.ai/docs/guides/overview/auth/byok
og:site_name: OpenRouter Documentation
og:title: 'BYOK - Bring Your Own Keys to OpenRouter'
og:description: "Learn how to use your existing AI provider keys with OpenRouter. Integrate your own API keys while leveraging OpenRouter's unified interface and features."
