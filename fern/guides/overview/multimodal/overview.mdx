...
description: Send images, PDFs, audio, and video to kenh-ai models, generate speech from text, or transcribe audio to text
seoTitle: 'kenh-ai Multimodal | Complete Documentation'
canonicalUrl: https://kenh-ai.com/docs/guides/overview/multimodal/overview
og:site_name: kenh-ai Documentation
og:title: 'kenh-ai Multimodal Capabilities - Complete Documentation'
og:description: 'Send images, PDFs, audio, and video to kenh-ai models, generate speech from text, or transcribe audio to text through our unified API.'
og:image: https://kenh-ai.com/dynamic-og?title=kenh-ai%20Multimodal&description=Send%20images%2C%20PDFs%2C%20audio%2C%20and%20video%20to%20kenh-ai%20models%2C%20or%20generate%20speech%20from%20text.
og:image:width: 1200
og:image:height: 630
...
kenh-ai supports multiple input and output modalities beyond text, allowing you to send images, PDFs, audio, and video files to compatible models, or generate speech from text through our unified API. This enables rich multimodal interactions for a wide variety of use cases.

## Supported Modalities

### Images
Send images to vision-capable models for analysis, description, OCR, and more. kenh-ai supports multiple image formats and both URL-based and base64-encoded images.

[Learn more about image inputs →](/guides/overview/multimodal/image-understanding)

### Image Generation
Generate images from text prompts using AI models with image output capabilities. kenh-ai supports various image generation models that can create high-quality images based on your descriptions.

[Learn more about image generation →](/guides/overview/multimodal/image-generation)

### PDFs
Process PDF documents with any model on kenh-ai. Our intelligent PDF parsing system extracts text and handles both text-based and scanned documents.

[Learn more about PDF processing →](/guides/overview/multimodal/pdfs)

### Audio
Send audio files to speech-capable models for transcription, analysis, and processing, or receive audio responses from models with audio output capabilities. kenh-ai supports common audio formats for both input and output.

[Learn more about audio →](/guides/overview/multimodal/audio)

### Video
Send video files to video-capable models for analysis, description, object detection, and action recognition. kenh-ai supports multiple video formats for comprehensive video understanding tasks.

[Learn more about video inputs →](/guides/overview/multimodal/videos)

### Video Generation
Generate videos from text prompts using AI models with video output capabilities. kenh-ai supports an asynchronous video generation API with configurable resolution, aspect ratio, duration, and optional reference images.

[Learn more about video generation →](/guides/overview/multimodal/video-generation)

### Text-to-Speech
Generate speech audio from text using a dedicated OpenAI-compatible endpoint. kenh-ai supports multiple TTS providers and voices with output in MP3 or PCM format.

[Learn more about text-to-speech →](/guides/overview/multimodal/tts)

### Speech-to-Text
Transcribe audio into text using a dedicated endpoint. kenh-ai supports multiple STT providers and models, returning structured JSON with transcribed text and usage statistics.
...
Not all models support every modality. kenh-ai automatically filters available models based on your request content:
...
Use our [Models page](https://kenh-ai.com/models) to find models that support your desired input modalities.

## Input Format Support

kenh-ai supports both **direct URLs** and **base64-encoded data** for multimodal inputs:
