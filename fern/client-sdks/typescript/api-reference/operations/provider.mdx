...
seoTitle: Provider Type | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/api-reference/operations/provider'
'og:site_name': kenh-ai Documentation
'og:title': Provider Type | kenh-ai TypeScript SDK
'og:description': >-
  Provider type reference for the kenh-ai TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Provider%20-%20TypeScript%20SDK&description=Provider%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { Provider } from "@kenh-ai/sdk/models/operations";
