...
- **Export all chats from playground** -- Added an "Export All Chats" option to the [chatroom](https://kenh-ai.com/chat) sidebar menu to download all conversations as a single JSON file.
...
- [**Qwen: Qwen3.7 Max**](https://kenh-ai.com/qwen/qwen3.7-max)
