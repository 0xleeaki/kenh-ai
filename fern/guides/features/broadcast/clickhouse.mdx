...
seoTitle: 'Broadcast to ClickHouse | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/clickhouse
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to ClickHouse - Send Traces to Your Analytics Database'
og:description: 'Connect ClickHouse to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for ClickHouse integration.'
og:image: https://kenh-ai.com/dynamic-og?title=ClickHouse%20Broadcast&description=Send%20traces%20to%20ClickHouse
og:image:width: 1200
og:image:height: 630
...
[ClickHouse](https://clickhouse.com) is a fast, open-source columnar database for real-time analytics. kenh-ai can stream traces directly to your ClickHouse database for high-performance analytics and custom dashboards.

## Step 1: Create the traces table

Before connecting kenh-ai, create the `KENH_AI_TRACES` table in your ClickHouse database. You can find the exact SQL in the kenh-ai dashboard when configuring the destination:

<Frame>
![ClickHouse Setup Instructions](/assets/guides/features/broadcast/clickhouse/broadcast-clickhouse-setup.png)
</Frame>
...
<Frame>
![ClickHouse Configuration](/assets/guides/features/broadcast/clickhouse/broadcast-clickhouse-config.png)
</Frame>
...
Make an API request through kenh-ai and query your ClickHouse table to verify the trace was received.
