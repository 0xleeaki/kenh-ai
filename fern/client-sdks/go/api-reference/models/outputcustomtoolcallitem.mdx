...
seoTitle: OutputCustomToolCallItem Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/outputcustomtoolcallitem
'og:site_name': kenh-ai Documentation
'og:title': OutputCustomToolCallItem Type | kenh-ai Go SDK
'og:description': >-
  OutputCustomToolCallItem type reference for the kenh-ai Go SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=OutputCustomToolCallItem%20-%20Go%20SDK&description=OutputCustomToolCallItem%20type%20definition
'og:image:width': 1200
'og:image:height': 630
