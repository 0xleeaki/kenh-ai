...
seoTitle: ReasoningDoneEvent Type | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/models/reasoningdoneevent'
'og:site_name': kenh-ai Documentation
'og:title': ReasoningDoneEvent Type | kenh-ai Go SDK
'og:description': >-
  ReasoningDoneEvent type reference for the kenh-ai Go SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ReasoningDoneEvent%20-%20Go%20SDK&description=ReasoningDoneEvent%20type%20definition
'og:image:width': 1200
'og:image:height': 630
