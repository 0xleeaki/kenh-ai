...
seoTitle: 'API Rate Limits | Configure Usage Limits in kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/api/reference/limits
og:site_name: kenh-ai Documentation
og:title: 'API Rate Limits - Manage Model Usage and Quotas'
og:description: "Learn about kenh-ai's API rate limits, credit-based quotas, and DDoS protection. Configure and monitor your model usage limits effectively."
og:image: https://kenh-ai.com/dynamic-og?title=API%20Rate%20Limits&description=Manage%20Model%20Usage%20and%20Quotas
og:image:width: 1200
og:image:height: 630
...
To check the rate limit or credits left on an API key, make a GET request to `https://kenh-ai.com/api/v1/key`.
...
const keyInfo = await kenhAi.apiKeys.getCurrent();
console.log(keyInfo);
```
...
response = requests.get(
  url="https://kenh-ai.com/api/v1/key",
  headers={
...
const response = await fetch('https://kenh-ai.com/api/v1/key', {
  method: 'GET',
  headers: {
