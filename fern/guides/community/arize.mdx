---
title: Arize
description: Using OpenRouter with Arize
seoTitle: 'Arize Integration | OpenRouter SDK Support'
canonicalUrl: https://openrouter.ai/docs/guides/community/arize
og:site_name: OpenRouter Documentation
og:title: 'Arize Integration - OpenRouter SDK Support'
og:description: 'Integrate OpenRouter using Arize for observability and tracing. Complete guide for Arize integration with OpenRouter for Python and JavaScript applications.'
og:image: https://openrouter.ai/dynamic-og?title=Arize&description=Arize%20Integration
og:image:width: 1200
og:image:height: 630
