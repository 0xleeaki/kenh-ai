...
seoTitle: 'Structured Outputs | Enforce JSON Schema in kenh-ai API Responses'
canonicalUrl: https://kenh-ai.com/docs/guides/features/structured-outputs
og:site_name: kenh-ai Documentation
og:title: 'Structured Outputs - Type-Safe JSON Responses from AI Models'
og:description: "Enforce JSON Schema validation on AI model responses. Get consistent, type-safe outputs and avoid parsing errors with kenh-ai's structured output feature."
og:image: https://kenh-ai.com/dynamic-og?title=Structured%20Outputs&description=Type-Safe%20JSON%20Responses%20from%20AI%20Models
og:image:width: 1200
og:image:height: 630
...
kenh-ai supports structured outputs for compatible models, ensuring responses follow a specific JSON Schema format. This feature is particularly useful when you need consistent, well-formatted responses that can be reliably parsed by your application.
...
You can find a list of models that support structured outputs on the [models page](https://kenh-ai.com/models?order=newest&supported_parameters=structured_outputs).
...
1. Check the model's supported parameters on the [models page](https://kenh-ai.com/models)
