...
seoTitle: 'Working with Items | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/items'
og:site_name: kenh-ai Documentation
og:title: 'Working with Items - kenh-ai SDK'
og:description: >-
...
og:image: >-
  https://kenh-ai.com/dynamic-og?title=Working%20with%20Items&description=Items-Based%20Streaming
og:image:width: 1200
og:image:height: 630
...
`callModel` is built on kenh-ai's Responses API which uses an **items-based
...
import type { StreamableOutputItem } from '@kenh-ai/agent';
