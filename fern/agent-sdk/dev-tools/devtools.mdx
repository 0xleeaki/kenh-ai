...
seoTitle: DevTools | kenh-ai SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/devtools'
og:site_name: kenh-ai Documentation
og:title: DevTools | kenh-ai SDK
og:description: >-
  Comprehensive development tools for the kenh-ai SDK. Capture telemetry, visualize requests, and debug your AI applications with ease.
og:image: >-
  https://kenh-ai.com/dynamic-og?title=DevTools&description=SDK%20Development%20Tools%20for%20telemetry%20capture%20and%20visualization
og:image:width: 1200
og:image:height: 630
...
The kenh-ai DevTools provide a comprehensive solution for SDK telemetry capture and visualization during development. Monitor your AI application's requests, responses, token usage, and errors in real-time with a beautiful web interface.

## Why use DevTools?

Building with AI SDKs requires visibility into what's happening under the hood. The kenh-ai DevTools give you complete insight into your SDK operations without adding complexity or impacting performance.
...
<Frame>
![DevTools Interface](/assets/sdk-devtools-dark.png)
</Frame>
...
```bash lines
npm install @kenh-ai/devtools --save-dev
```
...
```typescript lines
import { createOpenRouterDevtools } from '@kenh-ai/devtools';
import { KenhAI } from '@kenh-ai/sdk';

const sdk = new KenhAI({
...
The DevTools viewer runs on port 4983 by default. This can be configured in your kenh-ai CLI configuration at `~/.openrouter/claude-code-proxy.json`:
...
```bash lines
Cannot find module '@kenh-ai/devtools'
```
