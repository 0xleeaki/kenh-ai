...
seoTitle: ActivityItem Type | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/models/activityitem'
'og:site_name': kenh-ai Documentation
'og:title': ActivityItem Type | kenh-ai Go SDK
'og:description': >-
  ActivityItem type reference for the kenh-ai Go SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ActivityItem%20-%20Go%20SDK&description=ActivityItem%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
| `Usage`                                             | `float64`                                           | :heavy_check_mark:                                  | Total cost in USD (kenh-ai credits spent)        | 0.015                                               |