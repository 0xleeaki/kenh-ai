...
description: Add kenh-ai Client SDKs skills to your AI coding assistant
seoTitle: 'Usage for Agents | kenh-ai Client SDKs'
canonicalUrl: https://kenh-ai.com/docs/client-sdks/usage-for-agents
og:site_name: kenh-ai Documentation
og:title: 'Usage for Agents | kenh-ai Client SDKs'
og:description: >-
  Add kenh-ai Client SDKs skills to AI coding assistants like Claude Code, Cursor,
  GitHub Copilot, and more. Enable your AI to code with the kenh-ai Client SDKs.
og:image: >-
  https://kenh-ai.com/dynamic-og?pathname=client-sdks/usage-for-agents&title=Usage%20for%20Agents&description=Add%20kenh-ai%20Client%20SDKs%20skills%20to%20your%20AI%20coding%20assistant
og:image:width: 1200
og:image:height: 630
...
Give your AI coding assistant the knowledge to work with the kenh-ai Client SDKs
...
The skill covers both the Client SDKs (`@kenh-ai/sdk`) and the Agent SDK (`@kenh-ai/agent`).
...
- **SDK Installation & Setup** - How to install and configure `@kenh-ai/sdk`
...
**"Help me set up kenh-ai in my project"**
...
**"Add streaming to my kenh-ai call"**
