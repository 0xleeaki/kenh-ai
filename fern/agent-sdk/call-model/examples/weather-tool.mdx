...
seoTitle: 'Weather Tool Example | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/tool-examples/weather-tool'
og:site_name: kenh-ai Documentation
og:title: 'Weather Tool Example - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Weather%20Tool&description=API%20Integration%20Example
og:image:width: 1200
og:image:height: 630
...
export KENH_AI_API_KEY=your_openrouter_key
```
