...
seoTitle: 'Sensitive Info Guardrail | kenh-ai Data Protection'
canonicalUrl: https://kenh-ai.com/docs/guides/features/guardrails/sensitive-info
og:site_name: kenh-ai Documentation
og:title: 'Sensitive Info Guardrail - Automatic PII Detection and Redaction'
og:description: 'Protect sensitive data in your AI requests with kenh-ai Sensitive Info Guardrails. Automatically detect and redact or block PII like emails, phone numbers, names, addresses, and more.'
og:image: https://kenh-ai.com/dynamic-og?title=Sensitive%20Info%20Guardrail&description=Automatically%20detect%20and%20handle%20sensitive%20information
og:image:width: 1200
og:image:height: 630
...
kenh-ai uses two complementary detection methods:
...
Some types of sensitive information — like person names and physical addresses — cannot be reliably detected with simple patterns. For these, kenh-ai uses NLP-powered entity recognition (via [Presidio](https://microsoft.github.io/presidio/)), which analyzes text contextually.
...
1. Navigate to your workspace's **Privacy & Guardrails** page, or go to [Settings > Privacy](https://kenh-ai.com/settings/privacy).
