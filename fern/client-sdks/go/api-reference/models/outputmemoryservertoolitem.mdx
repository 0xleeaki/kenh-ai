...
seoTitle: OutputMemoryServerToolItem Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/outputmemoryservertoolitem
'og:site_name': kenh-ai Documentation
'og:title': OutputMemoryServerToolItem Type | kenh-ai Go SDK
'og:description': >-
  OutputMemoryServerToolItem type reference for the kenh-ai Go SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=OutputMemoryServerToolItem%20-%20Go%20SDK&description=OutputMemoryServerToolItem%20type%20definition
'og:image:width': 1200
'og:image:height': 630
