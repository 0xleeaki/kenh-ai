---
title: API Reference
description: Complete reference for the callModel API, ModelResult class, tool types, and helper functions.
seoTitle: 'API Reference | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/api-reference'
og:site_name: kenh-ai Documentation
og:title: 'API Reference - kenh-ai SDK'
og:description: 'Complete API reference for callModel, ModelResult, tool types, and helper functions in the kenh-ai SDK.'
og:image: https://kenh-ai.com/dynamic-og?title=API%20Reference&description=Complete%20Type%20Reference
og:image:width: 1200
og:image:height: 630
...
```typescript expandable lines
// Agent client
export { KenhAI } from '@kenh-ai/agent';
...
// Format helpers
export { fromChatMessages, toChatMessage, fromClaudeMessages, toClaudeMessage } from '@kenh-ai/agent';

// Stop condition helpers
export { stepCountIs, hasToolCall, maxTokensUsed, maxCost, finishReasonIs } from '@kenh-ai/agent';
