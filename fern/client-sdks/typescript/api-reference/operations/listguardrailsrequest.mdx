...
seoTitle: ListGuardrailsRequest Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/operations/listguardrailsrequest
'og:site_name': kenh-ai Documentation
'og:title': ListGuardrailsRequest Type | kenh-ai TypeScript SDK
'og:description': >-
  ListGuardrailsRequest type reference for the kenh-ai TypeScript SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ListGuardrailsRequest%20-%20TypeScript%20SDK&description=ListGuardrailsRequest%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { ListGuardrailsRequest } from "@kenh-ai/sdk/models/operations";
