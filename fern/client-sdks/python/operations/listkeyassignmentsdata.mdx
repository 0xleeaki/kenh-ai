---
title: ListKeyAssignmentsData - Python SDK
description: ListKeyAssignmentsData method reference
seoTitle: ListKeyAssignmentsData | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/operations/listkeyassignmentsdata'
'og:site_name': kenh-ai Documentation
'og:title': ListKeyAssignmentsData | kenh-ai Python SDK
'og:description': >-
  ListKeyAssignmentsData method documentation for the kenh-ai Python SDK.
  Learn how to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ListKeyAssignmentsData%20-%20Python%20SDK&description=ListKeyAssignmentsData%20method%20reference
'og:image:width': 1200
'og:image:height': 630
