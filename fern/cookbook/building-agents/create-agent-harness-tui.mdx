...
seoTitle: 'Build Your Own Agent TUI | kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/cookbook/building-agents/create-agent-harness-tui
og:site_name: kenh-ai Documentation
og:title: 'Build Your Own Agent TUI - kenh-ai'
og:description: 'Use the create-agent-tui skill to scaffold a custom AI agent in TypeScript with a customizable terminal UI, configurable tools, and streaming via @kenh-ai/agent.'
og:image: https://kenh-ai.com/dynamic-og?title=Build%20Your%20Own%20Agent%20TUI&description=Scaffold%20a%20custom%20AI%20agent%20with%20tools%20and%20streaming
og:image:width: 1200
og:image:height: 630
...
The [create-agent-tui](https://github.com/OpenRouterTeam/skills/tree/main/skills/create-agent-tui) skill scaffolds a complete agent TUI (terminal user interface) in TypeScript — like `create-react-app` for terminal agents. Tell your AI coding agent what kind of agent you want, and it generates a runnable project targeting [kenh-ai](https://kenh-ai.com) with a fully customizable terminal interface, tools, and configuration.

Under the hood, this is a full **agent harness**: the generated project uses [`@kenh-ai/agent`](https://www.npmjs.com/package/@kenh-ai/agent) for the inner loop (model calls, tool execution, stop conditions) and provides everything around it — configuration, tool definitions, session management, and the entry point.
...
The create-agent-tui skill is part of the [kenh-ai Skills](https://github.com/OpenRouterTeam/skills) collection. Install it with your AI coding agent of choice:
...
### What `@kenh-ai/agent` handles

| Concern | How the SDK handles it |
|---------|------------------------|
| **Model calls** | `client.callModel()` — one call, any model on kenh-ai |
...
<Frame>
![Grouped tool display](/assets/cookbook/building-agents/create-agent-harness-tui/tool-display-grouped.png)
</Frame>

**Emoji** — per-call markers with tool name, arguments, and timing:

<Frame>
![Emoji tool display](/assets/cookbook/building-agents/create-agent-harness-tui/tool-display-emoji.png)
</Frame>

**Minimal** — aggregated one-liner summaries:

<Frame>
![Minimal tool display](/assets/cookbook/building-agents/create-agent-harness-tui/tool-display-minimal.png)
</Frame>
...
<Frame>
![Block input style](/assets/cookbook/building-agents/create-agent-harness-tui/input-style-block.png)
</Frame>

**Bordered** — horizontal line frame that works on any terminal:

<Frame>
![Bordered input style](/assets/cookbook/building-agents/create-agent-harness-tui/input-style-bordered.png)
</Frame>

**Plain** — simple readline prompt, no escape sequences:

<Frame>
![Plain input style](/assets/cookbook/building-agents/create-agent-harness-tui/input-style-plain.png)
</Frame>
...
<Frame>
![Gradient loader](/assets/cookbook/building-agents/create-agent-harness-tui/loader-gradient.png)
</Frame>

**Spinner** — braille dot animation:

<Frame>
![Spinner loader](/assets/cookbook/building-agents/create-agent-harness-tui/loader-spinner.png)
</Frame>

**Minimal** — trailing dots:

<Frame>
![Minimal loader](/assets/cookbook/building-agents/create-agent-harness-tui/loader-minimal.png)
</Frame>
...
<Frame>
![ASCII banner on startup](/assets/cookbook/building-agents/create-agent-harness-tui/banner.png)
</Frame>
...
```expandable lines
my-agent/
  package.json              @kenh-ai/agent, zod, tsx
  tsconfig.json             ES2022, Node16, strict
  .env.example              KENH_AI_API_KEY=
  src/
...
<Frame>
![Agent TUI running in the terminal](/assets/cookbook/building-agents/create-agent-harness-tui/agent-harness-tui.png)
</Frame>
...
Executed by kenh-ai server-side — zero client code needed.
...
|---------|---------|-------------|
| `/model` | on | Switch model via kenh-ai API |
...
<Frame>
![A demo app built by the agent TUI](/assets/cookbook/building-agents/create-agent-harness-tui/agent-harness-demo.png)
</Frame>

## Resources

- [Create Agent TUI skill README](https://github.com/OpenRouterTeam/skills/tree/main/skills/create-agent-tui)
- [kenh-ai Skills repository](https://github.com/OpenRouterTeam/skills)
- [`@kenh-ai/agent` on npm](https://www.npmjs.com/package/@kenh-ai/agent)
- [kenh-ai TypeScript SDK](/client-sdks/typescript)
- [Server Tools documentation](/guides/features/server-tools)
- [kenh-ai API keys](https://kenh-ai.com/settings/keys)
