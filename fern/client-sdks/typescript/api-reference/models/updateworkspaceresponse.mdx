...
seoTitle: UpdateWorkspaceResponse Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/models/updateworkspaceresponse
'og:site_name': kenh-ai Documentation
'og:title': UpdateWorkspaceResponse Type | kenh-ai TypeScript SDK
'og:description': >-
  UpdateWorkspaceResponse type reference for the kenh-ai TypeScript SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=UpdateWorkspaceResponse%20-%20TypeScript%20SDK&description=UpdateWorkspaceResponse%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
import { UpdateWorkspaceResponse } from "@kenh-ai/sdk/models";
