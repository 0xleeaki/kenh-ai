...
seoTitle: 'Broadcast to Sentry | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/sentry
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to Sentry - Send Traces to Sentry'
og:description: 'Connect Sentry to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for Sentry integration.'
og:image: https://kenh-ai.com/dynamic-og?title=Sentry%20Broadcast&description=Send%20traces%20to%20Sentry
og:image:width: 1200
og:image:height: 630
...
Make an API request through kenh-ai and view the trace in Sentry's
Performance or Traces view.

<Frame>
![Sentry Trace View](/assets/guides/features/broadcast/sentry/broadcast-sentry-trace.png)
</Frame>
