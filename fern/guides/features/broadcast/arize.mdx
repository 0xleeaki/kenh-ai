---
title: Arize AI
description: Send traces to Arize AI
seoTitle: 'Broadcast to Arize AI | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/arize
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to Arize AI - Send Traces to Arize'
og:description: 'Connect Arize AI to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for Arize integration.'
og:image: https://kenh-ai.com/dynamic-og?title=Arize%20AI%20Broadcast&description=Send%20traces%20to%20Arize%20AI
og:image:width: 1200
og:image:height: 630
...
Make an API request through kenh-ai and view the trace in your Arize
