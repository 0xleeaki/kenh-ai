...
seoTitle: 'Broadcast to Langfuse | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/langfuse
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to Langfuse - Send Traces to Langfuse'
og:description: 'Connect Langfuse to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for Langfuse integration.'
og:image: https://kenh-ai.com/dynamic-og?title=Langfuse%20Broadcast&description=Send%20traces%20to%20Langfuse
og:image:width: 1200
og:image:height: 630
...
<Frame>
![Langfuse API Keys](/assets/guides/features/broadcast/langfuse/broadcast-langfuse-keys.png)
</Frame>
...
<Frame>
![Langfuse Configuration](/assets/guides/features/broadcast/langfuse/broadcast-langfuse-config.png)
</Frame>
...
<Frame>
![Langfuse Configured](/assets/guides/features/broadcast/langfuse/broadcast-langfuse-configured.png)
</Frame>

## Step 5: Send a test trace

Make an API request through kenh-ai and view the trace in Langfuse.

<Frame>
![Langfuse Trace](/assets/guides/features/broadcast/langfuse/broadcast-langfuse-trace.png)
</Frame>
