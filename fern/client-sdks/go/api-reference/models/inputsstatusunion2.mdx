...
seoTitle: InputsStatusUnion2 Type | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/models/inputsstatusunion2'
'og:site_name': kenh-ai Documentation
'og:title': InputsStatusUnion2 Type | kenh-ai Go SDK
'og:description': >-
  InputsStatusUnion2 type reference for the kenh-ai Go SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=InputsStatusUnion2%20-%20Go%20SDK&description=InputsStatusUnion2%20type%20definition
'og:image:width': 1200
'og:image:height': 630
