...
seoTitle: ActivityItem Type | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/api-reference/models/activityitem'
'og:site_name': kenh-ai Documentation
'og:title': ActivityItem Type | kenh-ai TypeScript SDK
'og:description': >-
  ActivityItem type reference for the kenh-ai TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ActivityItem%20-%20TypeScript%20SDK&description=ActivityItem%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { ActivityItem } from "@kenh-ai/sdk/models";
...
| `usage`                                             | *number*                                            | :heavy_check_mark:                                  | Total cost in USD (kenh-ai credits spent)        | 0.015                                               |