...
seoTitle: 'Broadcast to Grafana Cloud | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/grafana
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to Grafana Cloud - Send Traces to Grafana Tempo'
og:description: 'Connect Grafana Cloud to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for Grafana Cloud integration.'
og:image: https://kenh-ai.com/dynamic-og?title=Grafana%20Cloud%20Broadcast&description=Send%20traces%20to%20Grafana%20Cloud
og:image:width: 1200
og:image:height: 630
...
[Grafana Cloud](https://grafana.com/products/cloud/) is a fully-managed observability platform that includes Grafana Tempo for distributed tracing. kenh-ai sends traces via the standard OTLP HTTP/JSON endpoint.
...
<Frame>
![Grafana Cloud Configuration](/assets/guides/features/broadcast/grafana/broadcast-grafana-config.png)
</Frame>
...
<Frame>
![Grafana Cloud Configured](/assets/guides/features/broadcast/grafana/broadcast-grafana-configured.png)
</Frame>

## Step 5: Send a test trace

Make an API request through kenh-ai and view the trace in Grafana Cloud.

<Frame>
![Grafana Cloud Trace](/assets/guides/features/broadcast/grafana/broadcast-grafana-trace.png)
</Frame>
...
5. Run this query to see all kenh-ai traces:
...
kenh-ai traces include the following key attributes:

### Resource attributes
- `service.name`: Always `openrouter`
- `service.version`: `1.0.0`
- `openrouter.trace.id`: The kenh-ai trace ID
...
### Custom metadata
Any metadata you attach to your kenh-ai requests will appear under the `trace.metadata.*` namespace. See [Custom Metadata](#custom-metadata) below for details.
