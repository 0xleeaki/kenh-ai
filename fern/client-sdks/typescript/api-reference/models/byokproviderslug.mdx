...
seoTitle: BYOKProviderSlug Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/models/byokproviderslug
'og:site_name': kenh-ai Documentation
'og:title': BYOKProviderSlug Type | kenh-ai TypeScript SDK
'og:description': >-
  BYOKProviderSlug type reference for the kenh-ai TypeScript SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=BYOKProviderSlug%20-%20TypeScript%20SDK&description=BYOKProviderSlug%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { BYOKProviderSlug } from "@kenh-ai/sdk/models";
