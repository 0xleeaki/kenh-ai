---
title: Tools
description: Create type-safe tools with Zod schemas and automatic execution. Supports regular tools, generator tools with progress, manual tools, human-in-the-loop tools, and automatic multi-turn execution.
seoTitle: 'Tools | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/tools'
og:site_name: kenh-ai Documentation
og:title: 'Tools - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Tools&description=Type-safe%20Tool%20Creation
og:image:width: 1200
og:image:height: 630
...
```typescript lines
import type { InferToolInput, InferToolOutput, InferToolEvent } from '@kenh-ai/agent';
