...
seoTitle: SpeechRequest | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/api-reference/components/speechrequest'
'og:site_name': kenh-ai Documentation
'og:title': SpeechRequest | kenh-ai Python SDK
'og:description': >-
  SpeechRequest method documentation for the kenh-ai Python SDK. Learn how to
  use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=SpeechRequest%20-%20Python%20SDK&description=SpeechRequest%20method%20reference
'og:image:width': 1200
'og:image:height': 630
