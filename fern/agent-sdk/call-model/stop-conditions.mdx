...
seoTitle: 'Stop Conditions | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/stop-conditions'
og:site_name: kenh-ai Documentation
og:title: 'Stop Conditions - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Stop%20Conditions&description=Intelligent%20Execution%20Control
og:image:width: 1200
og:image:height: 630
...
```typescript lines
import { kenh-ai, stepCountIs } from '@kenh-ai/agent';
...
```typescript lines
import { stepCountIs } from '@kenh-ai/agent';
...
```typescript lines
import { hasToolCall } from '@kenh-ai/agent';
...
```typescript lines
import { maxTokensUsed } from '@kenh-ai/agent';
...
```typescript lines
import { maxCost } from '@kenh-ai/agent';
...
```typescript lines
import { finishReasonIs } from '@kenh-ai/agent';
...
```typescript lines
import { stepCountIs, hasToolCall, maxCost } from '@kenh-ai/agent';
...
import { stepCountIs, maxCost } from '@kenh-ai/agent';
