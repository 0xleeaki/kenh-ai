...
seoTitle: OutputBashServerToolItem Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/outputbashservertoolitem
'og:site_name': kenh-ai Documentation
'og:title': OutputBashServerToolItem Type | kenh-ai Go SDK
'og:description': >-
  OutputBashServerToolItem type reference for the kenh-ai Go SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=OutputBashServerToolItem%20-%20Go%20SDK&description=OutputBashServerToolItem%20type%20definition
'og:image:width': 1200
'og:image:height': 630
