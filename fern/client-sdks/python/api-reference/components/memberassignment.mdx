...
seoTitle: MemberAssignment | kenh-ai Python SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/python/api-reference/components/memberassignment
'og:site_name': kenh-ai Documentation
'og:title': MemberAssignment | kenh-ai Python SDK
'og:description': >-
  MemberAssignment method documentation for the kenh-ai Python SDK. Learn how
  to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=MemberAssignment%20-%20Python%20SDK&description=MemberAssignment%20method%20reference
'og:image:width': 1200
'og:image:height': 630
