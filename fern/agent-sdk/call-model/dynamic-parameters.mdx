...
seoTitle: 'Dynamic Parameters | kenh-ai SDK'
canonicalUrl: 'https://kenh-ai.com/docs/agent-sdks/typescript/call-model/dynamic-parameters'
og:site_name: kenh-ai Documentation
og:title: 'Dynamic Parameters - kenh-ai SDK'
...
og:image: https://kenh-ai.com/dynamic-og?title=Dynamic%20Parameters&description=Adaptive%20Model%20Behavior
og:image:width: 1200
og:image:height: 630
