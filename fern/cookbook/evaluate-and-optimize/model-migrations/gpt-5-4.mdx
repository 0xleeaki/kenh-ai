...
description: Support the phase field for GPT-5.3 Codex, GPT-5.4, and GPT-5.4 Pro
seoTitle: 'GPT-5.4 Migration Guide | kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/cookbook/evaluate-and-optimize/model-migrations/gpt-5-4
og:site_name: kenh-ai Documentation
og:title: 'GPT-5.4 Migration Guide'
og:description: >-
  Learn how to use the phase field for GPT-5.3 Codex,
  GPT-5.4, and GPT-5.4 Pro on kenh-ai.
og:image: https://kenh-ai.com/dynamic-og?title=GPT-5.4%20Migration%20Guide&description=Phase%20field%20support%20for%20GPT-5.3%20Codex%2C%20GPT-5.4%2C%20and%20GPT-5.4%20Pro
og:image:width: 1200
og:image:height: 630
...
- [kenh-ai API Documentation](/api/reference/overview)
