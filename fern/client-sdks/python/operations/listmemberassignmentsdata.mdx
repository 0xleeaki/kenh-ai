---
title: ListMemberAssignmentsData - Python SDK
description: ListMemberAssignmentsData method reference
seoTitle: ListMemberAssignmentsData | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/operations/listmemberassignmentsdata'
'og:site_name': kenh-ai Documentation
'og:title': ListMemberAssignmentsData | kenh-ai Python SDK
'og:description': >-
  ListMemberAssignmentsData method documentation for the kenh-ai Python SDK.
  Learn how to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=ListMemberAssignmentsData%20-%20Python%20SDK&description=ListMemberAssignmentsData%20method%20reference
'og:image:width': 1200
'og:image:height': 630
