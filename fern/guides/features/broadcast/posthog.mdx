...
seoTitle: 'Broadcast to PostHog | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast/posthog
og:site_name: kenh-ai Documentation
og:title: 'Broadcast to PostHog - Send Traces to PostHog'
og:description: 'Connect PostHog to automatically receive traces from your kenh-ai requests. Step-by-step setup guide for PostHog integration.'
og:image: https://kenh-ai.com/dynamic-og?title=PostHog%20Broadcast&description=Send%20traces%20to%20PostHog
og:image:width: 1200
og:image:height: 630
...
Make an API request through kenh-ai and view the LLM analytics in your
PostHog dashboard.

<Frame>
![PostHog LLM Analytics](/assets/guides/features/broadcast/posthog/broadcast-posthog-analytics.png)
</Frame>
...
kenh-ai maps the reserved `trace` fields below to PostHog's native `$ai_*` properties,
