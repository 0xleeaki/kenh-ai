...
seoTitle: PreferredMinThroughput Type | kenh-ai Go SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/go/api-reference/models/preferredminthroughput'
'og:site_name': kenh-ai Documentation
'og:title': PreferredMinThroughput Type | kenh-ai Go SDK
'og:description': >-
  PreferredMinThroughput type reference for the kenh-ai Go SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=PreferredMinThroughput%20-%20Go%20SDK&description=PreferredMinThroughput%20type%20definition
'og:image:width': 1200
'og:image:height': 630
