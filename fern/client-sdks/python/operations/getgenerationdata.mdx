---
title: GetGenerationData - Python SDK
description: GetGenerationData method reference
seoTitle: GetGenerationData | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/operations/getgenerationdata'
'og:site_name': kenh-ai Documentation
'og:title': GetGenerationData | kenh-ai Python SDK
'og:description': >-
  GetGenerationData method documentation for the kenh-ai Python SDK. Learn
  how to use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=GetGenerationData%20-%20Python%20SDK&description=GetGenerationData%20method%20reference
'og:image:width': 1200
'og:image:height': 630
...
| `origin`                                                 | *str*                                                    | :heavy_check_mark:                                       | Origin URL of the request                                | https://kenh-ai.com/                                   |
