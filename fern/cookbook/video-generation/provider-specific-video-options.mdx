...
seoTitle: 'Use Provider-Specific Video Options | kenh-ai Cookbook'
canonicalUrl: https://kenh-ai.com/docs/cookbook/video-generation/provider-specific-video-options
og:site_name: kenh-ai Documentation
og:title: 'Use Provider-Specific Video Options - kenh-ai Cookbook'
og:description: 'Use allowed_passthrough_parameters and provider.options to send model-specific video generation controls through kenh-ai.'
og:image: https://kenh-ai.com/dynamic-og?title=Use%20Provider-Specific%20Video%20Options&description=Pass%20provider%20video%20options%20through%20kenh-ai
og:image:width: 1200
og:image:height: 630
...
kenh-ai's normalized video schema.
...
- Node.js 20 or newer
- An kenh-ai API key available as `KENH_AI_API_KEY` only when you submit
  the video job
...
kenh-ai lists supported parameter names; check the provider docs for valid
...
```json lines
{
  ...
  "status": "completed",
  "polling_url": "https://kenh-ai.com/api/v1/videos/2hAwXrT31ZpCI8MsjBEe",
