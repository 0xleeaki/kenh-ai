...
seoTitle: KeyAssignment | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/api-reference/components/keyassignment'
'og:site_name': kenh-ai Documentation
'og:title': KeyAssignment | kenh-ai Python SDK
'og:description': >-
  KeyAssignment method documentation for the kenh-ai Python SDK. Learn how to
  use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=KeyAssignment%20-%20Python%20SDK&description=KeyAssignment%20method%20reference
'og:image:width': 1200
'og:image:height': 630
