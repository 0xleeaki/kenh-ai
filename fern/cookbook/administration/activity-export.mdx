...
seoTitle: 'Activity Export | Export Usage Reports with kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/cookbook/administration/activity-export
og:site_name: kenh-ai Documentation
og:title: 'Activity Export - Export Usage Reports as CSV or PDF'
og:description: 'Learn how to export your kenh-ai usage data as CSV or PDF reports, grouped by API key, model, or organization member.'
og:image: https://kenh-ai.com/dynamic-og?title=Activity%20Export&description=Export%20usage%20reports%20as%20CSV%20or%20PDF
og:image:width: 1200
og:image:height: 630
...
Export your aggregated usage data as CSV or PDF from the [Activity page](https://kenh-ai.com/activity).

## Overview

The Activity page shows three metrics:

- **Spend**: Total spend (kenh-ai credits + estimated BYOK spend)
...
<Frame>
![Spend by API Key](/assets/activity-export-spend-by-key.png)
</Frame>
...
<Frame>
![PDF Token Report](/assets/activity-export-pdf-tokens.png)
</Frame>
