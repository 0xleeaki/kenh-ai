...
seoTitle: Observability | kenh-ai Python SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/python/api-reference/observability'
'og:site_name': kenh-ai Documentation
'og:title': Observability | kenh-ai Python SDK
'og:description': >-
  Observability method documentation for the kenh-ai Python SDK. Learn how to
  use this API endpoint with code examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=Observability%20-%20Python%20SDK&description=Observability%20method%20reference
'og:image:width': 1200
'og:image:height': 630
...
| `x_open_router_title`                                                                                                                                     | *Optional[str]*                                                                                                                                           | :heavy_minus_sign:                                                                                                                                        | The app display name allows you to customize how your app appears in kenh-ai's dashboard.<br/>                                                         |                                                                                                                                                           |
| `x_open_router_categories`                                                                                                                                | *Optional[str]*                                                                                                                                           | :heavy_minus_sign:                                                                                                                                        | Comma-separated list of app categories (e.g. "cli-agent,cloud-agent"). Used for marketplace rankings.<br/>                                                |                                                                                                                                                           |
| `api_key_hashes`                                                                                                                                          | List[*str*]                                                                                                                                               | :heavy_minus_sign:                                                                                                                                        | Optional allowlist of kenh-ai API key hashes whose traffic is forwarded. `null` or omitted means all keys. Must contain at least one hash if provided. | `<nil>`                                                                                                                                                     |
...
| `x_open_router_title`                                                                                                                                                | *Optional[str]*                                                                                                                                                      | :heavy_minus_sign:                                                                                                                                                   | The app display name allows you to customize how your app appears in kenh-ai's dashboard.<br/>                                                                    |                                                                                                                                                                      |
| `x_open_router_categories`                                                                                                                                           | *Optional[str]*                                                                                                                                                      | :heavy_minus_sign:                                                                                                                                                   | Comma-separated list of app categories (e.g. "cli-agent,cloud-agent"). Used for marketplace rankings.<br/>                                                           |                                                                                                                                                                      |
| `api_key_hashes`                                                                                                                                                     | List[*str*]                                                                                                                                                          | :heavy_minus_sign:                                                                                                                                                   | Optional allowlist of kenh-ai API key hashes. `null` clears the filter (all keys). Omitting leaves the current value. Must contain at least one hash if provided. | `<nil>`                                                                                                                                                                |
