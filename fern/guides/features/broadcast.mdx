...
seoTitle: 'Broadcast | kenh-ai Observability'
canonicalUrl: https://kenh-ai.com/docs/guides/features/broadcast
og:site_name: kenh-ai Documentation
og:title: 'Broadcast - Send Traces to Observability Platforms'
og:description: 'Connect your LLM observability platforms to automatically receive traces from your kenh-ai requests. Supports Langfuse, Datadog, Braintrust, and more.'
og:image: https://kenh-ai.com/dynamic-og?title=Broadcast&description=Send%20traces%20to%20observability%20platforms
og:image:width: 1200
og:image:height: 630
...
Broadcast allows you to automatically send traces from your kenh-ai requests to external observability and analytics platforms. This feature enables you to monitor, debug, and analyze your LLM usage across your preferred tools without any additional instrumentation in your application code.

## Enabling Broadcast

To enable broadcast for your account or organization:

1. Navigate to [Settings > Observability](https://kenh-ai.com/settings/observability) in your kenh-ai dashboard
...
Once enabled, kenh-ai will automatically send trace data for all your API requests to your configured destinations.
...
- [Arize AI](/guides/features/broadcast/arize)
...
For the most up-to-date list of available destinations, visit the [Broadcast settings page](https://kenh-ai.com/settings/observability) in your dashboard.
...
| `parent_span_id` | Link your kenh-ai trace to an existing span from your own tracing system (e.g., OpenTelemetry). |
...
If you have your own tracing instrumentation (e.g., OpenTelemetry), you can use `parent_span_id` to nest kenh-ai calls under your existing spans:
...
└── Your Application Span (parent_span_id)
    └── openai/gpt-4o (generation from kenh-ai)
```
...
- Integrate kenh-ai traces with your existing application traces
...
- [Arize AI](/guides/features/broadcast/arize#custom-metadata) - Supports OpenInference span attributes and metadata
...
- [Arize AI](/guides/features/broadcast/arize) - ML observability and monitoring
