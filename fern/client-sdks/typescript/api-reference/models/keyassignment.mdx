...
seoTitle: KeyAssignment Type | kenh-ai TypeScript SDK
canonicalUrl: 'https://kenh-ai.com/docs/client-sdks/typescript/api-reference/models/keyassignment'
'og:site_name': kenh-ai Documentation
'og:title': KeyAssignment Type | kenh-ai TypeScript SDK
'og:description': >-
  KeyAssignment type reference for the kenh-ai TypeScript SDK. Complete type
  definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=KeyAssignment%20-%20TypeScript%20SDK&description=KeyAssignment%20type%20definition
'og:image:width': 1200
'og:image:height': 630
...
```typescript lines
import { KeyAssignment } from "@kenh-ai/sdk/models";
