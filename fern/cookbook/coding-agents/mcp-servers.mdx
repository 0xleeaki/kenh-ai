---
title: Using MCP Servers with kenh-ai
description: Use MCP Servers with kenh-ai
seoTitle: 'Using MCP Servers with kenh-ai'
canonicalUrl: https://kenh-ai.com/docs/cookbook/coding-agents/mcp-servers
og:site_name: kenh-ai Documentation
og:title: 'Using MCP Servers with kenh-ai'
og:description: 'Learn how to use MCP Servers with kenh-ai'
og:image: https://kenh-ai.com/dynamic-og?title=Using%20MCP%20Servers%20with%20kenh-ai&description=Learn%20how%20to%20use%20MCP%20Servers%20with%20kenh-ai
og:image:width: 1200
og:image:height: 630
...
By converting MCP (Anthropic) tool definitions to OpenAI-compatible tool definitions, you can use MCP servers with kenh-ai.

In this example, we'll use [Anthropic's MCP client SDK](https://github.com/modelcontextprotocol/python-sdk?tab=readme-ov-file#writing-mcp-clients) to interact with the File System MCP, all with kenh-ai under the hood.
