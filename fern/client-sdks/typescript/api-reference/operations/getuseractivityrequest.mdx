...
seoTitle: GetUserActivityRequest Type | kenh-ai TypeScript SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/typescript/api-reference/operations/getuseractivityrequest
'og:site_name': kenh-ai Documentation
'og:title': GetUserActivityRequest Type | kenh-ai TypeScript SDK
'og:description': >-
  GetUserActivityRequest type reference for the kenh-ai TypeScript SDK.
  Complete type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=GetUserActivityRequest%20-%20TypeScript%20SDK&description=GetUserActivityRequest%20type%20definition
'og:image:width': 1200
'og:image:height': 630
