...
seoTitle: FileSearchServerToolValue2 Type | kenh-ai Go SDK
canonicalUrl: >-
  https://kenh-ai.com/docs/sdks/go/api-reference/models/filesearchservertoolvalue2
'og:site_name': kenh-ai Documentation
'og:title': FileSearchServerToolValue2 Type | kenh-ai Go SDK
'og:description': >-
  FileSearchServerToolValue2 type reference for the kenh-ai Go SDK. Complete
  type definition and usage examples.
'og:image': >-
  https://kenh-ai.com/dynamic-og?title=FileSearchServerToolValue2%20-%20Go%20SDK&description=FileSearchServerToolValue2%20type%20definition
'og:image:width': 1200
'og:image:height': 630
